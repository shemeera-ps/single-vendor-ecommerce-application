...
class CartService implements ModelViewConnector {
    ...
    public function getCreatePageData(): CreatePageData
    {
        return new CreatePageData(
            ...
            form: FormHelper::makeForm(
                title: 'Create Cart',
                id: 'form_carts_create',
                action_route: 'carts.store',
                success_redirect_route: 'carts.index',
