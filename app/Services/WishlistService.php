...
class WishlistService implements ModelViewConnector {
    ...
    public function getCreatePageData(): CreatePageData
    {
        return new CreatePageData(
            ...
            form: FormHelper::makeForm(
                title: 'Create Wishlist',
                id: 'form_wishlists_create',
                action_route: 'wishlists.store',
                success_redirect_route: 'wishlists.index',
