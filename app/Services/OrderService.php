...
class OrderService implements ModelViewConnector {
    ...
    public function getCreatePageData(): CreatePageData
    {
        return new CreatePageData(
            ...
            form: FormHelper::makeForm(
                title: 'Create Order',
                id: 'form_orders_create',
                action_route: 'orders.store',
                success_redirect_route: 'orders.index',
