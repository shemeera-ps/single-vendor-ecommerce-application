...
class InvoiceService implements ModelViewConnector {
    ...
    public function getCreatePageData(): CreatePageData
    {
        return new CreatePageData(
            ...
            form: FormHelper::makeForm(
                title: 'Create Invoice',
                id: 'form_invoices_create',
                action_route: 'invoices.store',
                success_redirect_route: 'invoices.index',
